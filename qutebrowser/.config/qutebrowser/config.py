...
tayler_color_scheme.setup(c, "theme1", True)
...
# Type: Bool
# config.set('content.local_content_can_access_remote_urls', True, 'file:///home/user1/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
# config.set('content.local_content_can_access_file_urls', False, 'file:///home/user1/.local/share/qutebrowser/userscripts/*')
