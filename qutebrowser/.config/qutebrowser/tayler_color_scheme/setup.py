...
def setup(c, flavour, samecolorrows = False):
    ...
    if samecolorrows:
        c.colors.completion.even.bg = bg_menu
    ...
    c.colors.completion.item.selected.bg = bg_menu
    ...
    ## for transparency.
    c.colors.hints.bg = palette["bg-menu"]
    ...
    c.colors.keyhint.bg = palette["bg-menu"]
    ...
    c.colors.tabs.even.bg = bg_menu
    ## Background color of unselected odd tabs.
    c.colors.tabs.odd.bg = bg_menu
    ...
    c.colors.tabs.selected.even.bg = comment
    # ## Background color of selected odd tabs.
    c.colors.tabs.selected.odd.bg = comment
